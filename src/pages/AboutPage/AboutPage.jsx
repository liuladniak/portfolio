  ...
  return (
    <>
      ...
      <div className="about-page">
        <div className="about-page__content">
          <div className="about-card about-card--1">
            ...
            <p className="about-card__desc">
              I began my career with an engineering background, building a
              strong foundation in problem-solving and analytical thinking. As I
            ...
            <div className="about-card--2 about-card--mobile">
              <img src={aboutImg1} alt="image" />
            </div>
            <p className="about-card__desc">
              Throughout my career, I’ve been driven by the belief that clean
              code and thoughtful design are essential for a great user
              experience. My approach is focused on transforming complex
              requirements into seamless, intuitive interfaces that meet user
              needs and align with business goals.
            </p>
          </div>
        ...
        <div className="about-card about-card--2 about-card--tablet">
          <img src={aboutImg1} alt="image" />
        </div>
      </div>
    </>
